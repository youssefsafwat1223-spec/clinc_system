const DEFAULT_FAQS = [
  ...
  },
  {
    ...
    answer:
      'اكتب لنا كلمة "حجز" أو اذكر الخدمة اللي تحتاجها، ثم اختار الدكتور، اليوم، والوقت المتاح من الخيارات اللي هتظهرلك. بعدها يتم تسجيل الحجز بحالة (قيد الانتظار) ويتواصل معاك الاستقبال لتأكيده نهائياً.',
  },
  {
    question: 'كيف ألغي حجزي؟',
    answer:
      'ابعت لنا كلمة "إلغاء" أو "إلغاء الحجز" مع ذكر رقم الحجز إن أمكن، وسيتم إلغاء موعدك وإرسال رسالة تأكيد بالإلغاء. يمكنك أيضاً التواصل مع الاستقبال مباشرة.',
  },
  {
    question: 'كيف أعدل موعدي؟',
    answer:
      'ابعت لنا كلمة "تعديل" أو "تأجيل" مع ذكر رقم الحجز، وسنعرض عليك أقرب المواعيد البديلة. اختار الموعد المناسب وسيتم تحديث حجزك تلقائياً مع إرسال رسالة تأكيد جديدة.',
  },
];
