...
إذا كانت صياغة المريض باللهجة العراقية فحافظ على لهجة بسيطة ومفهومة.`,
  ...
  socialContactPrompt: 'إذا تحب نخلي الاستقبال يتواصل وياك، ابعت رقمك هنا وسنتواصل معك.',
  logoUrl: null,
  brandLogoUrl: null,
  ...
  try {
    ...
    const settings = await prisma.clinicSettings.update({
      ...
      data: {
        ...
        ...(locationImageUrl !== undefined && { locationImageUrl }),
        ...
        ...(socialContactPrompt !== undefined && { socialContactPrompt }),
