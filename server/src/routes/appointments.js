...
const { getAll, getOne, create, confirm, reject, update, block, complete, cancel, getStats, availability, rescheduleByDoctor } = require('../controllers/appointmentController');
